...
public class CountryPicker implements BottomSheetInteractionListener, LifecycleObserver {
  ...
  private final Country[] COUNTRIES = {
      ...
      new Country("AT", "Österreich", "+43", R.drawable.flag_at, "EUR"),
      ...
      new Country("ES", "Spanien", "+34", R.drawable.flag_es, "EUR"),
      ...
      new Country("HR", "Kroatien", "+385", R.drawable.flag_hr, "HRK"),
      ...
      new Country("IQ", "Irak", "+964", R.drawable.flag_iq, "IQD"),
      new Country("IR", "Iran", "+98", R.drawable.flag_ir, "IRR"),
      new Country("IS", "Iceland", "+354", R.drawable.flag_is, "ISK"),
      new Country("IT", "Italien", "+39", R.drawable.flag_it, "EUR"),
      ...
      new Country("NO", "Norwegen", "+47", R.drawable.flag_no, "NOK"),
      ...
      new Country("PL", "Polen", "+48", R.drawable.flag_pl, "PLN"),
      ...
      new Country("RO", "Rumänien", "+40", R.drawable.flag_ro, "RON"),
      new Country("RS", "Serbien", "+381", R.drawable.flag_rs, "RSD"),
      new Country("RU", "Russland", "+7", R.drawable.flag_ru, "RUB"),
      ...
      new Country("SE", "Schweden", "+46", R.drawable.flag_se, "SEK"),
      ...
      new Country("SY", "Syrien", "+963", R.drawable.flag_sy, "SYP"),
      ...
      new Country("TR", "Türkei", "+90", R.drawable.flag_tr, "TRY"),
